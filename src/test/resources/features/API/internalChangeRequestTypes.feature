Feature: Verify response for getting all internal change request types
  @TC2
  Scenario Outline:Response validation for getting all internal change request types
