Feature: Verify Virgil user is able to create Verify Virgil user is able to create a single related "Update Screening Number" DCR

  @UITC19
  Scenario: Verify MA-PP user is able to create a single related "Update Screening Number" DCR.
