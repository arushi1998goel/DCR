Feature: Verify Virgil user is able to create a single related request 'Move Survey' DCR
  @UITC11
  Scenario: Verify MA-PP user is able to create a single related request 'Move Survey' DCR
