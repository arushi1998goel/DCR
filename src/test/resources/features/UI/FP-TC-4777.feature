Feature: Verify Virgil user is able to create a single related request 'Remove Revision' Request.

  @UITC6
  Scenario: Verify MA-PP user is able to create a single related request 'Remove Revision' Request.
