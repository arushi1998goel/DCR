Feature: Verify Virgil user is able to create a single part ‘Remove Audio/Video’ DCR
  @UITC4
  Scenario: Verify MA-PP user is able to create a single single part ‘Remove Audio/Video’ DCR
