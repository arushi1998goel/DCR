Feature: Verify Virgil user is able to create a single related request 'Move Audio/Update Source File' DCR

  @UITC9
  Scenario: Verify MA-PP user is able to create a single related request 'Move Audio/Update Source File' DCR
