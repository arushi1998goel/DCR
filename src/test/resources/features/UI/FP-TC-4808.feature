Feature: Verify Virgil user is able to create a single related request 'Update Rater Name' DCR
  @UITC12
  Scenario: Verify MA-PP user is able to create a single related request 'Update Rater Name' DCR
