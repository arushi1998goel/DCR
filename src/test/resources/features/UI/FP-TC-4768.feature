Feature: Verify Virgil user is able to create a single related request "Remove Visit/SVID" DCR
  @UITC2
  Scenario: Verify MA-PP user is able to create a single related request "Remove Visit/SVID" DCR
