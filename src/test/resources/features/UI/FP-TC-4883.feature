Feature: Verify Virgil user is able to create a single related request 'Update Subject Randomization Number' DCR

  @UITC17
  Scenario: Verify MA-PP user is able to create a single related request 'Update Subject Randomization Number' DCR
