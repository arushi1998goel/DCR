Feature: Verify Virgil user is able to create a single related request 'Move/Rename Visit' DCR
  @UITC8
  Scenario: Verify MA-PP user is able to create a single related request 'Move/Rename Visit' DCR
