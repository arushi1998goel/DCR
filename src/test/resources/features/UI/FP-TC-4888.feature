Feature: Verify Virgil user is able to create a single related request "Add Assessment to Visit" Request
  @UITC20
  Scenario: Verify MA-PP user is able to create a single related request "Add Assessment to Visit" Request
