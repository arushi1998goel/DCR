Feature: Verify Virgil user is able to create a single related request 'Move Assessment' DCR

  @UITC7
  Scenario: Verify MA-PP user is able to create a single related request 'Move Assessment' DCR
