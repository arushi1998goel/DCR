Feature: Verify Virgil user is able to create a single related request 'Transfer Subject Between Sites' DCR

  @UITC10
  Scenario: Verify MA-PP user is able to create a single related request 'Transfer Subject Between Sites' DCR
