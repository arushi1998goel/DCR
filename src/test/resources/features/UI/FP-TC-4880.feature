Feature: Verify Virgil user is able to create a single related request 'Assign Rater' DCR

  @UITC14
  Scenario: Verify MA-PP user is able to create a single related request 'Assign Rater' DCR
