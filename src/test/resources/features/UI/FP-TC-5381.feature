Feature: Verify Virgil user is able to create a single related request "Update Assessment 'Paper Transcription' DCR

  @UITC22
  Scenario: Verify MA-PP user is able to create a single related request "Update Assessment 'Paper Transcription' DCR
