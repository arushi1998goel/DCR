Feature: Verify Virgil user is able to create a single related request 'Unassign Rater' DCR

  @UITC15
  Scenario: Verify MA-PP user is able to create a single related request 'Unassign Rater' DCR
